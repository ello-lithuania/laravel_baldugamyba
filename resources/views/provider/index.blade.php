    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('provider.create') }}">
                    @csrf
                    <!-- Section: Design Block -->
                  <div class="py-4 px-6">
                      <h2 class="font-bold text-[1.3rem]">Nurodykite savo kontaktinius duomenis, bei paslaugas</h2>
                      <p>Sulaukite klientų pasiūlymų greitu metu</p>
                      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 mt-4">
                          ...
                          <div class="col-span-1">
                              ...
                              <div class="flex items-center justify-center w-full">
                                  <label id="imagePreview" for="dropzone-file" class="bg-cover bg-no-repeat bg-center flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                      <div class="bg-black/60 w-full h-full flex flex-col items-center justify-center pt-5 pb-6">
                                          ...
                                          <p class="text-xs text-white">PNG, JPG, JPEG arba GIF formatu</p>
                                      </div>
                              ...
                              <div class="col-span-1">
                                  ...
                                  <div class="flex flex-col">
                                      <div class="flex flex-col">
                                          ...
                                          <input name="email" value="{{ old('email') }}" id="pavadinimas" type="email" autocomplete="off" class="text-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-white font-normal w-full min-w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border shadow" placeholder="Įrašykite elektroninį paštą" />
                                          @if ($errors->has('email'))
                              ...
                              <div class="col-span-1">
                                  <div class="max-w-sm">
                                      <div>
                                          ...
                                          <input name="website" value="{{ old('website') }}" type="text" class="text-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-white font-normal w-full min-w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border shadow" placeholder="www.pavyzdys.lt">
                                          </div>
                                      </div>
                                  </div>
